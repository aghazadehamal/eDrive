...
function CourseCard() {
  ...
  const videos = ["v1.MOV", "v2.MOV", "v3.MOV"];
  ...
  return (
    <div className="course-card">
      <div className="course-header">
        ...
        <p>
          Yol hərəkəti qaydalarını öyrənin və təhlükəsiz sürüş texnikaları ilə
          yola hazır olun.
        </p>
      ...
      <div className="course-details">
        ...
        <ul>
          ...
          <li>
            Avtomobil idarə edərkən tətbiq ediləcək təhlükəsizlik tədbirləri.
          </li>
