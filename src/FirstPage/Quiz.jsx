...
const questions = [
  {
    ...
    answerOptions: [
      {
        answerText: "Zədəliləri hərəkət etdirərək daha rahat bir yere götür.",
        isCorrect: false,
      },
      {
        answerText:
          "Yaralıya su və ya qida verərək onun daha yaxşı hiss etməsini təmin et.",
        isCorrect: false,
      },
      {
        answerText:
          "		 Təhlükəsizliyi təmin et, vəziyyəti qiymətləndir, yardım çağır, həyat əlamətlərini yoxla, qanamanı dayandır.",
        isCorrect: true,
      },
      {
        answerText:
          "İlk yardım çantasını açmadan əvvəl zədəli ilə müzakirə et ki, nə istədiyini öyrən.",
        isCorrect: false,
      },
    ],
  },
  {
    questionText:
      "Aşağıdakılardan hansı avtomobildə olması mütləq olan təhlükəsizlik avadanlıqlarından biri deyil?",
    answerOptions: [
  ...
  {
    questionText:
      " Aşağıdakılardan hansı səhv sollamanın nəticələrindən biri ola bilər?",
    answerOptions: [
      { answerText: "Cərimə alınması", isCorrect: false },
      {
        answerText: "Sürücülük vəsiqəsinin lisenziyanın geri çıxarılması",
        isCorrect: false,
      },
...

  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Yol qaydalarına daha səmimi yaxınlaşmaq",
        isCorrect: false,
      },
    ],
  },
  {
    questionText:
      " Sfetaforun yaşıl işığı yanarkən piyada keçidində piyadalara nə etməlisiniz?",
    answerOptions: [
      { answerText: "Sfetaforun qabağında drift etmək", isCorrect: false },
      {
        answerText: "		Piyadalara yol vermək və təhlükəsiz keçməsini təmin etmək",
        isCorrect: true,
      },
      {
        answerText: " Maşını	piyadalara  çırpmaq və yoldan kənara sürmək",
        isCorrect: false,
      },
  ...
  {
    questionText:
      "  Aşağıdakılardan hansı mator yağının vəzifələrindən biri deyil?",
    answerOptions: [
  ...
  {
    questionText:
      " Qarlı və buzlu yollarda avtomobil idarə edərkən hansı tədbirlər alınmalıdır?",
    answerOptions: [
  ...
  {
    questionText:
      " Aşağıdakılardan hansı diqqəti dağıdıcı bir hərəkət kimi qəbul edilmir?",
    answerOptions: [
      { answerText: "	Naviqasiya istifadə etmək", isCorrect: false },
      {
        answerText: "		düzgün bir şəkildə izləmə məsafəsini ayarlamaq ",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText:
          "	Lövhələrin rəngləri, xəbərdarlıq, qadağan, məlumatlandırma və yönləndirmə kimi fərqli məqsədləri göstərir.	",
        isCorrect: true,
      },
      {
        answerText:
          "Yol işarələrinin rəngləri hava şəraiti barədə məlumat verir.",
        isCorrect: false,
      },
      {
        answerText: "Rəngsiz trafik işarələri hər hansı bir məqsədi yoxdur.",
        isCorrect: false,
      },

      {
        answerText: "Qara rəngli lövhələr yolun təmiz olduğunu göstərir.",
        isCorrect: false,
      },
    ],
  },
